...
frappe.ui.form.on('Challenges and Commitments', {
	 onload: function(frm) {
	...
	"challenge_related_to":function(frm){
		var challenge_related_to = frm.doc.challenge_related_to;
		if(challenge_related_to == 'Project')
		{
